...
La solution proposée est "frwTNRWebSeleniumGherkin" basée sur Selenium webdriver, cucumber et Junit.

- frw = framework
- TNR = Tests de Non-Régression
- Web= Application web
- Selenium= Nom application
...
# Reporting 
Les résultats de test s’affichent dans un rapport Extent nommé Selenium.html dans le dossier Target / Cucumber-reports
